      ...
      >
        <Table.Header style={{ verticalAlign: "middle" }}>
          <Table.Row>
            ...
            {!isMobile && <Table.ColumnHeaderCell>Funding</Table.ColumnHeaderCell>}
            {!isMobile && <Table.ColumnHeaderCell>OI Balance</Table.ColumnHeaderCell>}
            {!isMobile && <Table.ColumnHeaderCell>Oracle</Table.ColumnHeaderCell>}
          ...
          {marketsData.length > 0 ?
            marketsData.map((market, index) => {
              ...
              return (
                ...
                >
                  <Table.Cell style={{ padding: isMobile ? "8px 0px" : "8px 16px" }}>
                    <Flex>
                      <img
                        style={{
                      ...
                      <span style={{ alignSelf: "center", marginLeft: 20 }}>
                        {isMobile && decodeURIComponent(market.marketId).length > 28 
                          ? `${decodeURIComponent(market.marketId).slice(0, 28)}...` 
                  ...
                  <Table.Cell>
                    {formatPriceWithCurrency(market.price ?? 0, market.priceCurrency, isMobile ? 3 : 4)}
                  </Table.Cell>
                  {!isMobile && <>
                    <Table.Cell
                      style={{
